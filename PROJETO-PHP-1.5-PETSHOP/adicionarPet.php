...
<body>
    ...
    <form action="adicionar_pet.php" method="post">
        ...
        <textarea id="observacoes" name="observacoes" rows="4" cols="50" placeholder="Vacinas, alergias, comportamento, etc."></textarea>
